        ...
        <Container>
            <div className={cn(s.root,'mb-5')}>
                        ...
                        <ProductSlider>
                            {
                                product?.images.map((image,i)=> {
                                    return (
                                        <div key={'image_'+i} className={s.imageContainer}>
                                            <Image
                                                className={s.img}
                ...
                <div className={s.sidebar}>
                    <section>
                        {
                            product.options.map((option,j) => {
                                return (
                                    <div key={product.id+"_"+j} className="pb-4">
                    ...
                    <div>
                        <Button className={s.button}
                                onClick={addToCart}
                                isLoading={isLoading}>Add to Cart</Button>
                    </div>
                </div>
            </div>
        </Container>
